        ...
        <section className="mb-16">
          <div className="space-y-4 text-gray-700">
            ...
            <p>
              ...
              project could be a way to help do that, and wants to contribute?
              We need you.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <ul className="mt-6 list-disc pl-6 space-y-2 text-gray-700">
            ...
            <li>
              ...
              recognize you can't do something you have your name on, that's
          ...
          <div className="mt-8 space-y-4">
            ...
            <p className="text-gray-700">
              ...
              contribute intensely for a short stretch, and we're accommodating
              of and deeply grateful for it all.
            </p>
          </div>
        </section>
