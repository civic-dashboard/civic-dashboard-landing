      ...
      <main className="min-h-screen bg-white max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-16">
          ...
          <p className="mt-4 text-xl text-gray-700">
            ...
            were once where you are, just hearing about this project for the
            first time! No matter who you are, you can contribute to this
            project.
          </p>
        </section>
        ...
        <section className="mb-16">
          <div className="space-y-4 text-gray-700">
            <p>
              ...
              research/writing, marketing/communication, or anything else
              relevant to a non-profit, open source technology project? We need
              you.
            </p>

            <p>
              If you have experience/expertise in government, policy,
              organizing, activism, campaigning, or anything related to
              political engagement? We need you.
            </p>
        ...
        <section className="mb-16">
          ...
          <ul className="mt-6 list-disc pl-6 space-y-2 text-gray-700">
            <li>
              ...
              name down for tasks, and feel free to add tasks if you want to
              work on something that isn&apos;t currently there. We trust your
              intelligence!
            </li>
            <li>
              <strong>Ownership</strong> - our only rule is that if you
              recognize you can&apos;t do something you have your name on,
              that&apos;s perfectly ok! Just let us know and we&apos;ll either
              get you help or find someone who can.
            </li>
            <li>
          ...
          <div className="mt-8 space-y-4">
            <p className="text-gray-700">
              We rarely set deadlines, we get the majority of our work done on
              our own time, and we communicate asynchronously via{" "}
              <a
            ...
            <p className="text-gray-700">
              ...
              project, we&apos;ve had folks come in and out, we&apos;ve had
              folks contribute intensely for a short stretch, and we&apos;re
        ...
        <section className="mb-16">
          ...
          <ul className="mt-6 list-disc pl-6 space-y-4 text-gray-700">
            <li>
              ...
              to get a sense of what we&apos;re building, where we&apos;re
              aiming, and how we&apos;re collaborating to get there.
            </li>
            <li>
